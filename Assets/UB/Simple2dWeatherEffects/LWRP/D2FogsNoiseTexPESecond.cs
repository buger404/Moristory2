...
{
    [Serializable]
    [PostProcess(typeof(D2FogsNoiseTexPESecondRenderer), PostProcessEvent.AfterStack, "UB/Simple2dWeatherEffects/LWRP/D2FogsNoiseTexPESecond")]
    ...
    public sealed class D2FogsNoiseTexPESecondRenderer : PostProcessEffectRenderer<D2FogsNoiseTexPESecond>
    {
        ...
        {
            var sheet = context.propertySheets.Get(Shader.Find("Hidden/UB/Simple2dWeatherEffects/LWRP/D2FogsNoiseTex"));
