...
namespace LPHailSet {
	...
	public class DemoSceneController : MonoBehaviour {
		...
		void Awake()
		{
			activeBtnStrength.GetComponent<Image>().style.color = btnActiveColor;
			btnNoWind.GetComponent<Image>().style.color = btnActiveColor;
		}
		...
		public void SetSoft()
		{
			...
			activeBtnStrength.GetComponent<Image>().style.color = Color.black;
		...
		public void SetWind()
		{
			...
			btnNoWind.GetComponent<Image>().style.color = Color.black;
			btnWind.GetComponent<Image>().style.color = btnActiveColor;
		}
		public void SetNoWind()
		{
			windZone.SetActive(false);
			
			btnWind.GetComponent<Image>().style.color = Color.black;
			btnNoWind.GetComponent<Image>().style.color = btnActiveColor;
		}
